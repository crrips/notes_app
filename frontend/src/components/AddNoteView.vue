<template>
  <div class="add-note-form">
    ...
    <div class="form-group">
      ...
      <input v-model="newNote.name" id="name" placeholder="Enter title" class="form-input" />
    </div>
    <div class="form-group">
      <label for="description" class="form-label">Description:</label>
      <textarea v-model="newNote.description" id="description" placeholder="Enter description" class="form-input description-input"></textarea>
    </div>
    <div class="form-actions">
      <button @click="saveNote" class="btn btn-save">Save</button>
